...
save_freq_neq = 10
#outdir_path = '/Output'
inpdir_path = '/home/vedant/Barnase-barstar system/Input/'
...
solvent_delivery = PointMutationExecutor(protein_filename = 'Input/1brs_barstar_renumbered.pdb',
                                         mutation_chain_id = 'D',
                                         mutation_residue_id = '4',
                                         proposed_residue = 'GLY',
